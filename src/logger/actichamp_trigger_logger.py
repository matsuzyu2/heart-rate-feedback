"""
ActiChampTriggerLoggerクラス - actiCHampトリガー送信イベントのCSV保存機能
"""
import csv
...
from ..config.ecg_config import ACTICHAMP_TRIGGER_LOG_DIRECTORY


class ActiChampTriggerLogger(BaseSessionLogger):
    """
    actiCHampトリガーイベントをCSVファイルに保存するクラス
    ...
    def _get_log_directory(self) -> str:
        ...
        Returns:
            str: ACTICHAMP_TRIGGER_LOG_DIRECTORYのパス
        """
        return ACTICHAMP_TRIGGER_LOG_DIRECTORY
    ...
    def _get_file_prefix(self) -> str:
        ...
        Returns:
            str: "actichamp_trigger"
        """
        return "actichamp_trigger"
    ...
    def _get_csv_columns(self) -> List[str]:
        ...
        Returns:
            List[str]: ActiChampTriggerデータのカラム名
        """
        return self.COLUMNS
    
    def log_trigger(self, trigger_value: int, annotation: str) -> None:
        """
        actiCHampトリガーイベントをCSVファイルに追記保存
